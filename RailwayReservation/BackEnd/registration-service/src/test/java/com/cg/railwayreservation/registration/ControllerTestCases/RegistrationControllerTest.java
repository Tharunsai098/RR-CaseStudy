...
public class RegistrationControllerTest {
    ...
    public void testSaveUserWithValidRole() throws Exception {
        ...
        Registration user = new Registration("tharun","Password","User","tharun@gmail.com","Male",23,"India");
    ...
    public void testSaveUserWithExistingUsername() throws Exception {
        Registration user = new Registration("powerstar", "Password", "User", "tharun@gmail.com", "Male", 23, "India");
